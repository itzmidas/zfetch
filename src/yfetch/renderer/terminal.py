"""Terminal rendering logic for yfetch with theme, gradient, and layout support."""

from typing import Optional

from yfetch.ascii.builtin import AsciiArt, get_builtin_ascii
from yfetch.ascii.gradient import apply_gradient_to_lines
from yfetch.ascii.manager import AsciiManager
from yfetch.config.schema import Config
import yfetch.modules  # Ensures all modules are registered
from yfetch.modules.base import ModuleRegistry, ModuleResult
from yfetch.themes.definitions import color_to_ansi, get_theme
