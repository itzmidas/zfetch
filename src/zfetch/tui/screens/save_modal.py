...
from zfetch.tui.widgets import MenuItem
...
class SaveExitModal(ModalScreen[str]):
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="save-dialog"):
            yield Label("Save your zfetch configuration?", id="save-title")
            with ListView(id="save-list"):
                yield MenuItem("save", "💾 Save and exit", "Write changes to ~/.config/zfetch/config.toml")
